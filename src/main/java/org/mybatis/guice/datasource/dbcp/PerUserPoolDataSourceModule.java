...
public final class PerUserPoolDataSourceModule extends AbstractModule {
    ...
    private PerUserPoolDataSourceModule(Class<? extends Provider<Map<String, Boolean>>> perUserDefaultAutoCommitProviderClass, Class<? extends Provider<Map<String, Boolean>>> perUserDefaultReadOnlyProviderClass, Class<? extends Provider<Map<String, Integer>>> perUserDefaultTransactionIsolationProviderClass, Class<? extends Provider<Map<String, Integer>>> perUserMaxActiveProviderClass, Class<? extends Provider<Map<String, Integer>>> perUserMaxIdleProviderClass, Class<? extends Provider<Map<String, Long>>> perUserMaxWaitMillisProviderClass) {
    ...
    private <T> void doBind(Class<? extends Provider<T>> providerClass, TypeLiteral<T> typeLiteral, Class<? extends Annotation> annotation) {
    ...
    public static final class Builder {
         ...
         * @return the builder
         */
        public Builder setPerUserDefaultAutoCommitProviderClass(Class<? extends Provider<Map<String, Boolean>>> perUserDefaultAutoCommitProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return the builder
         */
        public Builder setPerUserDefaultReadOnlyProviderClass(Class<? extends Provider<Map<String, Boolean>>> perUserDefaultReadOnlyProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return the builder
         */
        public Builder setPerUserDefaultTransactionIsolationProviderClass(Class<? extends Provider<Map<String, Integer>>> perUserDefaultTransactionIsolationProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return the builder
         */
        public Builder setPerUserMaxTotalProviderClass(Class<? extends Provider<Map<String, Integer>>> perUserMaxActiveProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return the builder
         */
        public Builder setPerUserMaxIdleProviderClass(Class<? extends Provider<Map<String, Integer>>> perUserMaxIdleProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
         ...
         * @return the builder
         */
        public Builder setPerUserMaxWaitMillisProviderClass(Class<? extends Provider<Map<String, Long>>> perUserMaxWaitProviderClass) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
